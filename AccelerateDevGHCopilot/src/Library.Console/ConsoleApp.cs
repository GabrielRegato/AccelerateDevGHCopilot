...
public class ConsoleApp
{
    ...
    )
    {
        ...
        _jsonData = jsonData; // Store JsonData
        // NOTE: If you get System.InvalidOperationException from Microsoft.Extensions.DependencyInjection.dll,
        // it likely means JsonData is not registered in your DI container.
        // Register it in your DI setup, e.g.:
    ...
    async Task<ConsoleState> PatronSearchResults()
    {
        ...
        if (action == CommonActions.Select)
        {
            ...
            {
                selectedPatronDetails = matchingPatrons[selectedPatronNumber - 1];
                // Optionally reload full patron details from repository
    ...
    async Task<ConsoleState> SearchBooks()
    {
        ...
        if (bookItem == null)
        {
            Console.WriteLine($"No book item found for book: {book.Title}");
            return ConsoleState.PatronDetails;
        }
